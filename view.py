...
start_date = f"{latest_pred_date}+00:00"
end_date = f"{latest_pred_date}+23:59"
...
if not actual_data:
    raise Exception(f"No actual data returned from API for {latest_pred_date}.")
...
plt.title(f"Actual vs Predicted Consumption on {latest_pred_date}")
...
# ---------------- BUILD PDF REPORT ---------------- #
pdf_path = f"actual_vs_pred_report_{latest_pred_date}.pdf"
...
# Summary
summary = f"""
<b>Consumption Report for {latest_pred_date}</b><br/><br/>
